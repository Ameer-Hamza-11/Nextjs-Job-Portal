...
export const ApplyJobModal = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[500px] w-[95%] max-w-[95%] sm:max-w-[500px] rounded-lg p-0 overflow-hidden">
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-120px)] p-4 sm:p-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
            ...
            {/* Action Buttons */}
            <div className="flex flex-col-reverse sm:flex-row sm:items-center justify-end gap-3 sm:gap-4 pt-2 sm:pt-4 sticky bottom-0 bg-white py-4 -mb-4 border-t mt-4">
              <Button
                type="button"
                variant="outline"
